...
3. Alternatively, you can use the green `CODE` button at the top of the [main repo page](https://github.com/rfulkerson/24spring1400) to download a ZIP file of the entire directory structure.
